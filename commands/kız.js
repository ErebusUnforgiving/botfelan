...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        db.push(`isimler_${member.id}`, ` \`⁰⁷ ${name} | ${age}\` (<@&824149056036667399>,<@&824166949788319775>)`);
        ...
        message.channel.send(embed2.setDescription(`⁰⁷ ${member} adlı kullanıcı \`⁰⁷ ${name} | ${age}\` isminde kayıt edildi! Kullanıcıya verilen roller: <@&824149056036667399>,<@824166949788319775>`)
